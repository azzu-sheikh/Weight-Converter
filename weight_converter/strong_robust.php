...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT id, amount, from_weight, to_weight FROM weight_conversion WHERE test_case_type IN ('Weak and Strong Robust', 'Strong Robust')";
...
<head>
    ...
    <title>Strong Robust Cases</title>
    <style>
        body {
...
<a href="http://localhost/weight_converter/convert.php" class="back-button">Back</a>
    <div class="container">
        <h1>Strong Robust Test Cases</h1>
        <table id="dataTable">
            <thead>
                <tr>
                    <th>ID</th>
