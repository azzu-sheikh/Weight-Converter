...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT id, amount, from_weight, to_weight FROM weight_conversion WHERE test_case_type='Weak and Strong Robust'";
